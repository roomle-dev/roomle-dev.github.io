System.register(['./roomle-dependency-injection-91bf96dc.nomodule.js', './main-thread-to-worker-d8be741d.nomodule.js'], (function (exports, module) {
  'use strict';
...
`;
      ...
      class SceneManager {
          ...
          showStats() {
              module.import('./stats-helper-041429e7.nomodule.js').then((statsHelper) => (this._statsHelper = new statsHelper.default()));
          }
          _onKeyDown(_event) {
...
//# sourceMappingURL=scene-manager-f69095ff.nomodule.js.map
