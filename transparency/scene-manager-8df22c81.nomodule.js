System.register(['./roomle-dependency-injection-7f97b68f.nomodule.js', './main-thread-to-worker-5209e492.nomodule.js'], (function (exports, module) {
  'use strict';
  var __decorate, inject, EventDispatcher, toRadiant, position3VectorsAreEqual, position2VectorsAreEqual, compareBox3Size, getIdealDistance, toDegrees, MaterialCreator, createMaterial, addTexture, getGUI, rotationQuaternionsAreEqual, getDelta, MIN_MOVE_DISTANCE, LightSourceDetector, EnvironmentMapDecodeMaterial, RoomleWebGLRenderer, standaloneConfiguratorQualityLevels, ENV_HDR_256_FILE_NAME, dispose, DynamicLightSettingLoader, RoomleComponentFactoryInitializer, Vector3, debounce, PerspectiveCamera, Vector2, areCameraParametersEqual, Sphere, Box3, Euler, Quaternion, deepMerge, Object3D, Mesh, Shape, Path, ShapeGeometry, TextureLoader, Fog, Color, RepeatWrapping, DoubleSide, OrthographicCamera, MathUtils, handleJsonResponse, SpotLight, AmbientLight, DirectionalLight, RectAreaLight, IcosahedronGeometry, ShaderMaterial, PlaneGeometry, MeshBasicMaterial, CircleGeometry, LineBasicMaterial, BufferGeometry, LineSegments, PMREMGenerator, Matrix3, NoBlending, CubeTexture, Texture, Scene, BoxGeometry, Clock, sanitizedCameraMode, getColor, WebGLRenderer, SRGBColorSpace, PCFSoftShadowMap, download;
  return {
    setters: [function (module) {
      ...
      toRadiant = module.t;
      position3VectorsAreEqual = module.H;
      position2VectorsAreEqual = module.J;
      compareBox3Size = module.K;
      getIdealDistance = module.p;
      toDegrees = module.s;
      MaterialCreator = module.M;
      createMaterial = module.N;
      addTexture = module.O;
      getGUI = module.Q;
      rotationQuaternionsAreEqual = module.S;
      getDelta = module.T;
      MIN_MOVE_DISTANCE = module.U;
      LightSourceDetector = module.V;
      EnvironmentMapDecodeMaterial = module.W;
      RoomleWebGLRenderer = module.X;
      standaloneConfiguratorQualityLevels = module.Y;
      ENV_HDR_256_FILE_NAME = module.Z;
      dispose = module.n;
      ...
      Vector3 = module.a;
      debounce = module.bz;
      PerspectiveCamera = module.N;
      Vector2 = module.V;
      areCameraParametersEqual = module.bA;
      Sphere = module.ae;
      Box3 = module.ad;
      Euler = module.ag;
      Quaternion = module.Q;
      ...
      Shape = module.bC;
      Path = module.bD;
      ShapeGeometry = module.bE;
      TextureLoader = module.m;
      Fog = module.bF;
      Color = module.C;
      RepeatWrapping = module.r;
      DoubleSide = module.w;
      OrthographicCamera = module.W;
      MathUtils = module.U;
      handleJsonResponse = module.aT;
      SpotLight = module.S;
      AmbientLight = module.A;
      DirectionalLight = module.D;
      RectAreaLight = module.R;
      IcosahedronGeometry = module.bG;
      ShaderMaterial = module.ao;
      PlaneGeometry = module.b8;
      MeshBasicMaterial = module.h;
      CircleGeometry = module.bH;
      LineBasicMaterial = module.u;
      BufferGeometry = module.B;
      LineSegments = module.E;
      PMREMGenerator = module.bI;
      Matrix3 = module.an;
      NoBlending = module.au;
      CubeTexture = module.ah;
      Texture = module.a9;
      Scene = module.al;
      BoxGeometry = module.aN;
      Clock = module.bJ;
      sanitizedCameraMode = module.bB;
      getColor = module.bK;
      WebGLRenderer = module.bv;
      SRGBColorSpace = module.i;
      PCFSoftShadowMap = module.bk;
      download = module.bL;
    }],
    execute: (function () {
      ...
      var TWEEN_FILE_NAME = exports('T', "static/Tween-d57ee5d181fce582.js");
      ...
      const DISTANCE_FACTOR = exports('D', 2.725);
      ...
      } exports('c', CameraControlFirstPerson);
      ...
      } exports('B', BackgroundEnvironment);
...
`;
      ...
      class SceneManager {
          ...
          showStats() {
              module.import('./stats-helper-08d25032.nomodule.js').then((statsHelper) => (this._statsHelper = new statsHelper.default()));
          }
          _onKeyDown(_event) {
          ...
          setBackgroundColor(hex) {
              ...
              //   new BackgroundEnvironment(
              //     this._scene,
              //     this._environment,
              //     new Color(hex as ColorRepresentation)
              //   )
              // );
          }
...
//# sourceMappingURL=scene-manager-8df22c81.nomodule.js.map
