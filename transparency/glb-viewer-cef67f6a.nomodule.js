System.register(['./script-loader-cf78b8d1.nomodule.js', './roomle-dependency-injection-85668395.nomodule.js', './scene-manager-84bf2765.nomodule.js', './main-thread-to-worker-d8be741d.nomodule.js', './default-light-setting-717522db.nomodule.js', './query-params-helper-d83ee85d.nomodule.js'], (function (exports) {
  'use strict';
  var ScriptLoader, Main, InputManager, DependencyInjectionAssignment, Logger, RapiAccess, getGUI, __decorate, inject, CANVAS_ID, DynamicLightSettingLoader, PREDEFINED_LIGHTSETTING, dispose, RoomleDependencyInjection, CameraControl3D, LightSetting, SceneManager, TWEEN_FILE_NAME, Vector3, Box3, Euler, Quaternion, AmbientLight, Color, CAMERA_TYPE, getGlbUrl, WebGLRenderer, SRGBColorSpace, BasicShadowMap, PerspectiveCamera, download, DefaultLightSetting;
  return {
    ...
    execute: (function () {
      ...
      } exports('GlbViewer', GlbViewer);

    })
  };
}));
//# sourceMappingURL=glb-viewer-cef67f6a.nomodule.js.map
