...
import { S as SceneEventHandler, C as ConfiguratorSceneManager, R as RoomleConfigurator } from './roomle-configurator-df421cd7.js';
...
class RoomlePlanner {
    ...
    async switchToConfigurator() {
        const configurator = await this._singlePromiseFactory.create(3 /* PROMISE_CATEGORY.START_HSC */, 'startHSC', (resolve) => {
            ...
            import('./configurator-b3c594b4.js').then(({ Configurator: ConfiguratorClass }) => {
...
export { Planner };
//# sourceMappingURL=planner-631de2e1.js.map
