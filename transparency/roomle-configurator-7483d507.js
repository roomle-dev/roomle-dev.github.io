...
import { D as DefaultLightSetting } from './default-light-setting-3bf50a43.js';
...
class ConfiguratorSceneManager extends SceneManager {
    ...
    async _initOptionalModules() {
        ...
        if (transparentHighlighting) {
            const { default: ComponentRaycastHelperClass } = await import('./component-raycast-helper-805c88f7.js');
    ...
    async _initDimensions() {
        if (!this._dimensionHelper) {
            await import('./dimensioning-helper-021669b9.js').then(({ default: DimensionHelper }) => {
...
//# sourceMappingURL=roomle-configurator-7483d507.js.map
