...
import { S as SceneEventHandler, C as ConfiguratorSceneManager, R as RoomleConfigurator } from './roomle-configurator-c56ad3b7.js';
...
class PlannerSceneEventHandler extends SceneEventHandler {
    ...
    async _initMobileDrawing() {
        ...
        if (!this._continuousDrawingHelper) {
            const { default: ContinuousDrawingHelperClass } = await import('./continuous-drawing-helper-75f8c02d.js');
...
class RoomlePlanner {
    ...
    async switchToConfigurator() {
        const configurator = await this._singlePromiseFactory.create(3 /* PROMISE_CATEGORY.START_HSC */, 'startHSC', (resolve) => {
            ...
            import('./configurator-e7dc48a8.js').then(({ Configurator: ConfiguratorClass }) => {
    ...
    async switchToViewer() {
        const viewer = await this._singlePromiseFactory.create(4 /* PROMISE_CATEGORY.START_GLB */, 'startGLB', (resolve) => {
            ...
            import('./glb-viewer-cd9965b0.js').then((GLBViewerModule) => {
...
export { Planner };
//# sourceMappingURL=planner-2f6f6abd.js.map
