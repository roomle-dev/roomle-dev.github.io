...
import { L as LightSetting, B as BackgroundEnvironment, C as CameraControl3D, b as CameraControl2D, c as CameraControlFirstPerson, T as TWEEN_FILE_NAME } from './scene-manager-507f3ee5.js';
...
import { S as SceneEventHandler, C as ConfiguratorSceneManager, R as RoomleConfigurator } from './roomle-configurator-bf9126c5.js';
...
class RoomlePlanner {
    ...
    async switchToConfigurator() {
        const configurator = await this._singlePromiseFactory.create(3 /* PROMISE_CATEGORY.START_HSC */, 'startHSC', (resolve) => {
            ...
            import('./configurator-3362e50a.js').then(({ Configurator: ConfiguratorClass }) => {
    ...
    async switchToViewer() {
        const viewer = await this._singlePromiseFactory.create(4 /* PROMISE_CATEGORY.START_GLB */, 'startGLB', (resolve) => {
            ...
            import('./glb-viewer-f0789e14.js').then((GLBViewerModule) => {
...
export { Planner };
//# sourceMappingURL=planner-297dc0f6.js.map
