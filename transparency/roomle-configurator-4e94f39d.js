import { E as EventDispatcher, v as vectorIsZero, d as disposeMesh, c as convertToKernel, t as toRadiant, _ as __decorate, i as inject, g as getScreenXY, e as CANVAS_ID, f as Env, b as RoomleDependencyInjection, P as PULSE_LOOPS, h as PULSE_DURATION, j as DynamicLightSettingLoader, k as PREDEFINED_LIGHTSETTING, l as ImageRenderer, m as createEmptySceneFromCurrent, n as dispose, o as getYRotationOfObject, p as getIdealDistance, B as Benchmark, q as getHostname, r as RoomleComponentFactoryInitializer, s as toDegrees, u as DEFAULT_CONVERSATION_ID, w as getCatalogIdFromItemOrConfigurationId, x as isIdItemId, A as AppContext, y as AsyncHelper, z as isRange, F as isMaterial, G as convertCObject } from './roomle-dependency-injection-0a65a99a.js';
import { S as SceneManager, B as BackgroundEnvironment, D as DISTANCE_FACTOR, C as CameraControl3D, F as FloorEnvironment, T as TWEEN_FILE_NAME } from './scene-manager-c6dbbb15.js';
import { a as Vector3, bw as Raycaster, bx as Plane, V as Vector2, Q as Quaternion, z as Mesh, bu as Layers, aB as deepMerge, ad as Box3, by as callAgainAfter, bz as debounce, bA as getColor, ag as Euler, bB as areCameraParametersEqual, aD as ROOMLE_HIGHLIGHTNG } from './main-thread-to-worker-8a755a37.js';
import { D as DefaultLightSetting } from './default-light-setting-c3fb86b1.js';
...
class ConfiguratorSceneManager extends SceneManager {
    ...
    async _initOptionalModules() {
        ...
        if (transparentHighlighting) {
            const { default: ComponentRaycastHelperClass } = await import('./component-raycast-helper-1d0e0e19.js');
    ...
    async _initDimensions() {
        if (!this._dimensionHelper) {
            await import('./dimensioning-helper-15001d13.js').then(({ default: DimensionHelper }) => {
...
//# sourceMappingURL=roomle-configurator-4e94f39d.js.map
