...
import { D as DefaultLightSetting } from './default-light-setting-030ad02c.js';
...
class ConfiguratorSceneManager extends SceneManager {
    ...
    async _initOptionalModules() {
        ...
        if (transparentHighlighting) {
            const { default: ComponentRaycastHelperClass } = await import('./component-raycast-helper-61c4a36b.js');
    ...
    async _initDimensions() {
        if (!this._dimensionHelper) {
            await import('./dimensioning-helper-d52ec7b4.js').then(({ default: DimensionHelper }) => {
...
//# sourceMappingURL=roomle-configurator-8d99e363.js.map
