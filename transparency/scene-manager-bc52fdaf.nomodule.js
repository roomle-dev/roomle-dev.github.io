System.register(['./roomle-dependency-injection-f62f5de7.nomodule.js', './main-thread-to-worker-d8be741d.nomodule.js'], (function (exports, module) {
  'use strict';
...
`;
      ...
      class SceneManager {
          ...
          showStats() {
              module.import('./stats-helper-5705e2e9.nomodule.js').then((statsHelper) => (this._statsHelper = new statsHelper.default()));
          }
          _onKeyDown(_event) {
...
//# sourceMappingURL=scene-manager-bc52fdaf.nomodule.js.map
