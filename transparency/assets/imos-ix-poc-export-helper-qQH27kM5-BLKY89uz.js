import{Qn as e,zi as t,zr as n}from"./index-DtPgIJ8D.js";var r=(e,t)=>`${e.x.toFixed(t)},${e.y.toFixed(t)},${e.z.toFixed(t)}`,i=(e,t)=>{let n=``;for(let r=0;r<t.length;r++)n+=`<${e}${r+1}>${t[r]}</${e}${r+1}>
    `;return n},a=e=>`<Head>
            <COMM>${e.comm}</COMM>
