...
import { D as DefaultLightSetting } from './default-light-setting-71a4ef57.js';
...
class ConfiguratorSceneManager extends SceneManager {
    ...
    async _initOptionalModules() {
        ...
        if (transparentHighlighting) {
            const { default: ComponentRaycastHelperClass } = await import('./component-raycast-helper-9150faac.js');
    ...
    async _initDimensions() {
        if (!this._dimensionHelper) {
            await import('./dimensioning-helper-661154b0.js').then(({ default: DimensionHelper }) => {
...
//# sourceMappingURL=roomle-configurator-c56ad3b7.js.map
