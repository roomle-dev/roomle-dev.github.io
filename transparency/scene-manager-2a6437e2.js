...
class SceneManager {
    ...
    showStats() {
        import('./stats-helper-96f72b48.js').then((statsHelper) => (this._statsHelper = new statsHelper.default()));
    }
    _onKeyDown(_event) {
...
//# sourceMappingURL=scene-manager-2a6437e2.js.map
