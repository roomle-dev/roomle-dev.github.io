...
import { S as SceneEventHandler, C as ConfiguratorSceneManager, R as RoomleConfigurator } from './roomle-configurator-89b65abb.js';
...
class RoomlePlanner {
    ...
    async switchToConfigurator() {
        const configurator = await this._singlePromiseFactory.create(3 /* PROMISE_CATEGORY.START_HSC */, 'startHSC', (resolve) => {
            ...
            import('./configurator-752b5c5b.js').then(({ Configurator: ConfiguratorClass }) => {
...
export { Planner };
//# sourceMappingURL=planner-991aa153.js.map
