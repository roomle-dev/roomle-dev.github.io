...
class SceneManager {
    ...
    showStats() {
        import('./stats-helper-abb7dc8a.js').then((statsHelper) => (this._statsHelper = new statsHelper.default()));
    }
    _onKeyDown(_event) {
...
//# sourceMappingURL=scene-manager-392463ea.js.map
