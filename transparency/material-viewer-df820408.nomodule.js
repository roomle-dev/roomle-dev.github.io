System.register(['./script-loader-cf78b8d1.nomodule.js', './roomle-dependency-injection-85668395.nomodule.js', './scene-manager-a602aff6.nomodule.js', './main-thread-to-worker-d8be741d.nomodule.js', './query-params-helper-d83ee85d.nomodule.js'], (function (exports) {
  'use strict';
  var ScriptLoader, Main, __decorate, inject, CANVAS_ID, DynamicLightSettingLoader, PREDEFINED_LIGHTSETTING, MaterialCreator, setMaterial, getMaterialShading, getGUI, addExistingTexture, addTexture, UiCallback, DependencyInjectionAssignment, Logger, InputManager, ConfiguratorMeshGenerator, RapiAccess, RoomleDependencyInjection, SceneManager, BackgroundEnvironment, CameraControl3D, FloorEnvironment, TWEEN_FILE_NAME, CAMERA_TYPE, BoxGeometry, Mesh, Color, Box3, Vector3, DoubleSide, FrontSide, SphereGeometry, PlaneGeometry, Texture;
  return {
    setters: [function (module) {
      ...
      setMaterial = module.au;
      getMaterialShading = module.av;
      getGUI = module.Q;
      addExistingTexture = module.aw;
      addTexture = module.O;
      UiCallback = module.ax;
      DependencyInjectionAssignment = module.D;
      Logger = module.L;
      InputManager = module.as;
      ConfiguratorMeshGenerator = module.ay;
      RapiAccess = module.R;
    ...
    execute: (function () {
      ...
      } exports('MaterialViewer', MaterialViewer);

    })
  };
}));
//# sourceMappingURL=material-viewer-df820408.nomodule.js.map
