...
import { D as DefaultLightSetting } from './default-light-setting-372fbc55.js';
...
class ConfiguratorSceneManager extends SceneManager {
    ...
    async _initOptionalModules() {
        ...
        if (transparentHighlighting) {
            const { default: ComponentRaycastHelperClass } = await import('./component-raycast-helper-1dfda6a2.js');
    ...
    async _initDimensions() {
        if (!this._dimensionHelper) {
            await import('./dimensioning-helper-c1c6a4b2.js').then(({ default: DimensionHelper }) => {
...
//# sourceMappingURL=roomle-configurator-b1cc21c2.js.map
