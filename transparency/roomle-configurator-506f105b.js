...
import { D as DefaultLightSetting } from './default-light-setting-75312589.js';
...
class ConfiguratorSceneManager extends SceneManager {
    ...
    async _initOptionalModules() {
        ...
        if (transparentHighlighting) {
            const { default: ComponentRaycastHelperClass } = await import('./component-raycast-helper-7ebdaeb3.js');
    ...
    async _initDimensions() {
        if (!this._dimensionHelper) {
            await import('./dimensioning-helper-32d9233f.js').then(({ default: DimensionHelper }) => {
...
//# sourceMappingURL=roomle-configurator-506f105b.js.map
