System.register(['./script-loader-cea79081.nomodule.js', './roomle-dependency-injection-f62f5de7.nomodule.js', './scene-manager-1ba15b88.nomodule.js', './main-thread-to-worker-d8be741d.nomodule.js', './roomle-configurator-19419421.nomodule.js', './query-params-helper-d83ee85d.nomodule.js', './default-light-setting-84cfe6cf.nomodule.js'], (function (exports, module) {
  'use strict';
      ...
      class PlannerSceneEventHandler extends SceneEventHandler {
          ...
          async _initMobileDrawing() {
              ...
              if (!this._continuousDrawingHelper) {
                  const { default: ContinuousDrawingHelperClass } = await module.import('./continuous-drawing-helper-240cd6c2.nomodule.js');
      ...
      class RoomlePlanner {
          ...
          async switchToConfigurator() {
              const configurator = await this._singlePromiseFactory.create(3 /* PROMISE_CATEGORY.START_HSC */, 'startHSC', (resolve) => {
                  ...
                  module.import('./configurator-c3a62adc.nomodule.js').then(({ Configurator: ConfiguratorClass }) => {
          ...
          async switchToViewer() {
              const viewer = await this._singlePromiseFactory.create(4 /* PROMISE_CATEGORY.START_GLB */, 'startGLB', (resolve) => {
                  ...
                  module.import('./glb-viewer-04c43f36.nomodule.js').then((GLBViewerModule) => {
...
//# sourceMappingURL=planner-90212337.nomodule.js.map
