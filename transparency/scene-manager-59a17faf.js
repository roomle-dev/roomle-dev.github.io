...
class SceneManager {
    ...
    showStats() {
        import('./stats-helper-1fe37d4d.js').then((statsHelper) => (this._statsHelper = new statsHelper.default()));
    }
    _onKeyDown(_event) {
...
//# sourceMappingURL=scene-manager-59a17faf.js.map
