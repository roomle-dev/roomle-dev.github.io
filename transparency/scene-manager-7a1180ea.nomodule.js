...
`;
      ...
      class SceneManager {
          ...
          constructor(creator, offset, canvasID, mode) {
              ...
              this._setupScene(offset, this._initData.transparentBackground);
          ...
          showStats() {
              module.import('./stats-helper-ddae1163.nomodule.js').then((statsHelper) => (this._statsHelper = new statsHelper.default()));
          }
          _onKeyDown(_event) {
...
//# sourceMappingURL=scene-manager-7a1180ea.nomodule.js.map
