System.register(['./script-loader-b3cb01ae.nomodule.js', './roomle-dependency-injection-7f97b68f.nomodule.js', './scene-manager-8df22c81.nomodule.js', './main-thread-to-worker-5209e492.nomodule.js', './roomle-configurator-cd913de0.nomodule.js', './query-params-helper-5f20148b.nomodule.js', './default-light-setting-5a9663ff.nomodule.js'], (function (exports, module) {
  'use strict';
  var ScriptLoader, Main, getGUI, EventDispatcher, WallPlanElementViewModel, FloorPlanElementViewModel, __decorate, inject, MEASUREMENTS_LINE_DRAGGABLE_POINTS_NAME, convertToKernel, MeasurementLinePlanElementViewModel, NodePlanElementViewModel, isSafari, convertToTHREE, ConfiguratorPlanObjectViewModel, StaticPlanObjectViewModel, INPUT_DELAY_TYPE, ConfiguratorViewModel, ConstructionPlanObjectViewModel, CeilingPlanElementViewModel, kernelBoxToThreeBox, PlannerKernelAccess, threeVectorToTransferableXY, getScreenXY, convertCObject, AsyncGuard, RenderMode, PLAN_ELEMENT_CHANGE_TYPES, getHostname, hideWallsBasedOnCamera, MaterialCreator, fadeIn, viewSpacePositionFromUV, setWallTransparency, getDrawingMinBounds, ImageRenderer, createEmptySceneFromCurrent, dispose, toMeasurementLineDimensionToTransferable, objectToWallDimensionToTransferable, toConstructionMeasurementTransferable, wallDimensionToTransferable, isIdItemId, Benchmark, isPlanSnapshotId, DynamicLightSettingLoader, InputManager, DependencyInjectionAssignment, Logger, PlannerMeshGenerator, RapiAccess, RoomleDependencyInjection, LightSetting, CameraControl3D, CameraControl2D, CameraControlFirstPerson, TWEEN_FILE_NAME, Vector3, AmbientLight, Color, DirectionalLight, Vector2, Sphere, Layers, deepMerge, PlaneGeometry, MeshBasicMaterial, Mesh, setCursor, wait, CAMERA_TYPE, Box3, Group, ShaderMaterial, UniformsUtils, BackSide, BoxGeometry, TextureLoader, RepeatWrapping, copy, SphereGeometry, applyMaterialToKernelMaterial, MathUtils, SceneEventHandler, ConfiguratorSceneManager, RoomleConfigurator;
  return {
    setters: [function (module) {
      ...
      WallPlanElementViewModel = module.a0;
      FloorPlanElementViewModel = module.a1;
      __decorate = module._;
      inject = module.i;
      MEASUREMENTS_LINE_DRAGGABLE_POINTS_NAME = module.a2;
      convertToKernel = module.c;
      MeasurementLinePlanElementViewModel = module.a3;
      NodePlanElementViewModel = module.a4;
      isSafari = module.a5;
      convertToTHREE = module.a6;
      ConfiguratorPlanObjectViewModel = module.a7;
      StaticPlanObjectViewModel = module.a8;
      INPUT_DELAY_TYPE = module.a9;
      ConfiguratorViewModel = module.C;
      ConstructionPlanObjectViewModel = module.aa;
      CeilingPlanElementViewModel = module.ab;
      kernelBoxToThreeBox = module.ac;
      PlannerKernelAccess = module.ad;
      threeVectorToTransferableXY = module.ae;
      getScreenXY = module.g;
      convertCObject = module.G;
      AsyncGuard = module.af;
      RenderMode = module.ag;
      PLAN_ELEMENT_CHANGE_TYPES = module.ah;
      getHostname = module.q;
      hideWallsBasedOnCamera = module.ai;
      MaterialCreator = module.M;
      fadeIn = module.aj;
      viewSpacePositionFromUV = module.ak;
      setWallTransparency = module.al;
      getDrawingMinBounds = module.am;
      ImageRenderer = module.l;
      createEmptySceneFromCurrent = module.m;
      dispose = module.n;
      toMeasurementLineDimensionToTransferable = module.an;
      objectToWallDimensionToTransferable = module.ao;
      toConstructionMeasurementTransferable = module.ap;
      wallDimensionToTransferable = module.aq;
      isIdItemId = module.x;
      Benchmark = module.B;
      isPlanSnapshotId = module.ar;
      DynamicLightSettingLoader = module.j;
      InputManager = module.as;
      DependencyInjectionAssignment = module.D;
      Logger = module.L;
      PlannerMeshGenerator = module.at;
      RapiAccess = module.R;
      RoomleDependencyInjection = module.b;
    }, function (module) {
      LightSetting = module.L;
      CameraControl3D = module.C;
      CameraControl2D = module.b;
      CameraControlFirstPerson = module.c;
      ...
      applyMaterialToKernelMaterial = module.bP;
      MathUtils = module.U;
    }, function (module) {
      SceneEventHandler = module.S;
      ...
      class PlannerSceneEventHandler extends SceneEventHandler {
          ...
          async _initMobileDrawing() {
              ...
              if (!this._continuousDrawingHelper) {
                  const { default: ContinuousDrawingHelperClass } = await module.import('./continuous-drawing-helper-85d64125.nomodule.js');
      ...
      class RoomlePlanner {
          ...
          async switchToConfigurator() {
              const configurator = await this._singlePromiseFactory.create(3 /* PROMISE_CATEGORY.START_HSC */, 'startHSC', (resolve) => {
                  ...
                  module.import('./configurator-95f9db5e.nomodule.js').then(({ Configurator: ConfiguratorClass }) => {
          ...
          async switchToViewer() {
              const viewer = await this._singlePromiseFactory.create(4 /* PROMISE_CATEGORY.START_GLB */, 'startGLB', (resolve) => {
                  ...
                  module.import('./glb-viewer-2901cad9.nomodule.js').then((GLBViewerModule) => {
...
//# sourceMappingURL=planner-e7778589.nomodule.js.map
