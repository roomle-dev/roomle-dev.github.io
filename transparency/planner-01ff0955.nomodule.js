System.register(['./script-loader-cea79081.nomodule.js', './roomle-dependency-injection-f62f5de7.nomodule.js', './scene-manager-bc52fdaf.nomodule.js', './main-thread-to-worker-d8be741d.nomodule.js', './roomle-configurator-40d84929.nomodule.js', './query-params-helper-d83ee85d.nomodule.js', './default-light-setting-eb74393b.nomodule.js'], (function (exports, module) {
  'use strict';
      ...
      class RoomlePlanner {
          ...
          async switchToConfigurator() {
              const configurator = await this._singlePromiseFactory.create(3 /* PROMISE_CATEGORY.START_HSC */, 'startHSC', (resolve) => {
                  ...
                  module.import('./configurator-a03cb73f.nomodule.js').then(({ Configurator: ConfiguratorClass }) => {
          ...
          async switchToViewer() {
              const viewer = await this._singlePromiseFactory.create(4 /* PROMISE_CATEGORY.START_GLB */, 'startGLB', (resolve) => {
                  ...
                  module.import('./glb-viewer-78d4057a.nomodule.js').then((GLBViewerModule) => {
...
//# sourceMappingURL=planner-01ff0955.nomodule.js.map
