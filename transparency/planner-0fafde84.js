...
import { L as LightSetting, C as CameraControl3D, b as CameraControl2D, c as CameraControlFirstPerson, T as TWEEN_FILE_NAME } from './scene-manager-13a40131.js';
...
import { S as SceneEventHandler, C as ConfiguratorSceneManager, R as RoomleConfigurator } from './roomle-configurator-bba8fcb1.js';
...
class RoomlePlanner {
    ...
    async switchToConfigurator() {
        const configurator = await this._singlePromiseFactory.create(3 /* PROMISE_CATEGORY.START_HSC */, 'startHSC', (resolve) => {
            ...
            import('./configurator-aa521e70.js').then(({ Configurator: ConfiguratorClass }) => {
    ...
    async switchToViewer() {
        const viewer = await this._singlePromiseFactory.create(4 /* PROMISE_CATEGORY.START_GLB */, 'startGLB', (resolve) => {
            ...
            import('./glb-viewer-b294c84f.js').then((GLBViewerModule) => {
...
export { Planner };
//# sourceMappingURL=planner-0fafde84.js.map
