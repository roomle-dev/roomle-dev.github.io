System.register(['./roomle-dependency-injection-a13fccf4.nomodule.js', './scene-manager-166ac363.nomodule.js', './main-thread-to-worker-5209e492.nomodule.js', './default-light-setting-4116815b.nomodule.js'], (function (exports, module) {
  'use strict';
      ...
      class ConfiguratorSceneManager extends SceneManager {
          ...
          async _initOptionalModules() {
              ...
              if (transparentHighlighting) {
                  const { default: ComponentRaycastHelperClass } = await module.import('./component-raycast-helper-41866651.nomodule.js');
          ...
          async _initDimensions() {
              if (!this._dimensionHelper) {
                  await module.import('./dimensioning-helper-6f50e82c.nomodule.js').then(({ default: DimensionHelper }) => {
...
//# sourceMappingURL=roomle-configurator-1be896ea.nomodule.js.map
