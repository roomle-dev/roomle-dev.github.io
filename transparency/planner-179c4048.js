...
import { S as SceneEventHandler, C as ConfiguratorSceneManager, R as RoomleConfigurator } from './roomle-configurator-8f38f3cd.js';
...
class PlannerSceneEventHandler extends SceneEventHandler {
    ...
    async _initMobileDrawing() {
        ...
        if (!this._continuousDrawingHelper) {
            const { default: ContinuousDrawingHelperClass } = await import('./continuous-drawing-helper-78ed8eca.js');
...
class RoomlePlanner {
    ...
    async switchToConfigurator() {
        const configurator = await this._singlePromiseFactory.create(3 /* PROMISE_CATEGORY.START_HSC */, 'startHSC', (resolve) => {
            ...
            import('./configurator-88a66a78.js').then(({ Configurator: ConfiguratorClass }) => {
    ...
    async switchToViewer() {
        const viewer = await this._singlePromiseFactory.create(4 /* PROMISE_CATEGORY.START_GLB */, 'startGLB', (resolve) => {
            ...
            import('./glb-viewer-c64aeac2.js').then((GLBViewerModule) => {
...
export { Planner };
//# sourceMappingURL=planner-179c4048.js.map
