...
class SceneManager {
    ...
    showStats() {
        import('./stats-helper-7ac3d8fa.js').then((statsHelper) => (this._statsHelper = new statsHelper.default()));
    }
    _onKeyDown(_event) {
...
//# sourceMappingURL=scene-manager-5071d3d7.js.map
