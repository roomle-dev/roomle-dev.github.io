...
import { D as DefaultLightSetting } from './default-light-setting-c92b35c1.js';
...
class ConfiguratorSceneManager extends SceneManager {
    ...
    async _initOptionalModules() {
        ...
        if (transparentHighlighting) {
            const { default: ComponentRaycastHelperClass } = await import('./component-raycast-helper-ff1744d2.js');
    ...
    async _initDimensions() {
        if (!this._dimensionHelper) {
            await import('./dimensioning-helper-c14e085e.js').then(({ default: DimensionHelper }) => {
...
//# sourceMappingURL=roomle-configurator-58c56166.js.map
